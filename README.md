...
### Papers
[[DATE 2020] Optimising Resource Management for Embedded Machine Learning](https://arxiv.org/abs/2105.03608)
### Talks
1. [[TinyML EMEA] Runtime DNN Performance Scaling through Resource Management on Heterogeneous Embedded Platforms](https://youtu.be/XW8jBooRPdM)
2. [[KTN & eFutures Online Webinar] Adapting AI to Available Resource in Mobile/Embedded Devices](https://youtu.be/DnApKW5lk5k)
