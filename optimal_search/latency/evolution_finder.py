...
class ArchManager:
	def __init__(self):
		self.num_blocks = 20
		self.num_stages = 5
		self.kernel_sizes = [5,7]
		self.expand_ratios = [4,6]
		self.depths = [3,4]
		self.resolutions = [i for i in range(208,224,4)] #narrow the resolution range can reduce the search cost
...
class EvolutionFinder:
	valid_constraint_range = {
		'flops': [95, 850],
		'note10': [15, 60],
		'jetson': [200, 5000], #Set the latency constratnt range to avoid wrong input
	}
