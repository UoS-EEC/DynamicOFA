...
class LatencyTable:
	def __init__(self, device='note10', resolutions=(160,164,168,172,176,180,184,188,192,196,200,204,208,212,216,220,224)):
		self.latency_tables = {}

		for image_size in resolutions:
			self.latency_tables[image_size] = LatencyEstimator(
				url='checkpoints/latency_table@%s/%d_lookup_table.json' % (device, image_size)
			)
