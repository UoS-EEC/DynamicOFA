...
class FLOPsTable:
	def __init__(self, pred_type='flops', device='cuda:0', multiplier=1.0, batch_size=64, load_efficiency_table=None):
	...
	def build_lut(self, batch_size=1, resolutions=[160,164,168,172,176,180,184,188,192,196,200,204,208,212,216,220,224]):
