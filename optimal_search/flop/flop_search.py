...
params = {
    ...
    'efficiency_constraint': 200,  # FLops constraint (M), suggested range [150, 600]
...
# start searching
result_lis = []
for flops in range(700,800,20): #Set the search flop constraint
...
file=open(r"GPUflopresult_700_800.pickle","wb")
